(function (global, factory) {
    ...
    (global = global || self, global['@wonderlandlabs/rollup_starter-kit'] = factory());
    ...
    ***************************************************************************** */
    ...
    const PHASE_DEFAULT_LIST = [PHASE_PRE, PHASE_DO, PHASE_POST];
    ...
    class Mirror extends BehaviorSubject {
      ...
      $do(name, ...args) {
        const { thrownError, value } = this.$send(asUserAction(name), { args, result: UNHANDLED });
