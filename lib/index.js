(function (global, factory) {
    ...
    ***************************************************************************** */
    ...
    const EVENT_TYPE_SHARD = 'next:shard';
    const EVENT_TYPE_TRY = 'try';
    const EVENT_TYPE_ACCEPT_AFTER = 'event:acceptAfter';
    const EVENT_TYPE_REMOVE_AFTER = 'event:removeAfter';
    const EVENT_TYPE_CHILD_ADDED = 'child:added';
    const EVENT_TYPE_REVERT = 'event:revert';
    const EVENT_TYPE_COMMIT = 'event:commit';
    const EVENT_TYPE_COMMIT_CHILDREN = 'event:commit:children';
    ...
    var constants = /*#__PURE__*/Object.freeze({
        ...
        EVENT_TYPE_SHARD: EVENT_TYPE_SHARD,
        EVENT_TYPE_TRY: EVENT_TYPE_TRY,
        EVENT_TYPE_ACCEPT_AFTER: EVENT_TYPE_ACCEPT_AFTER,
        EVENT_TYPE_REMOVE_AFTER: EVENT_TYPE_REMOVE_AFTER,
        EVENT_TYPE_CHILD_ADDED: EVENT_TYPE_CHILD_ADDED,
        EVENT_TYPE_REVERT: EVENT_TYPE_REVERT,
        EVENT_TYPE_COMMIT: EVENT_TYPE_COMMIT,
        EVENT_TYPE_COMMIT_CHILDREN: EVENT_TYPE_COMMIT_CHILDREN,
