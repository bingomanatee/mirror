(function (global, factory) {
    ...
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, global["@wonderlandlabs/mirror"] = factory(global.crypto, global.buffer));
    ...
    ***************************************************************************** */
    ...
    var uuid_1 = typeof crypto__default["default"].randomUUID === 'function'
      ? crypto__default["default"].randomUUID
      : esmNode.v4;
    ...
    const Buffer$1 = buffer__default["default"].Buffer;
    ...
    const isMirror = (target) => target instanceof Mirror$1;
    const create = (...args) => new Mirror$1(...args);
    ...
    class Mirror extends childMixin(cleanMixin(propsMixin(actionMixin(eventMixin(BehaviorSubject))))) {
