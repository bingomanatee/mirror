(function (global, factory) {
    ...
    ***************************************************************************** */
    ...
    var withEvents = (BaseClass) => class WithChildren extends BaseClass {
      constructor(...args) {
        super(...args);
        this.$on(
          EVENT_TYPE_NEXT,
     ...
     */
    class Mirror extends withAction(withChildren(withEvents(withTrans(BehaviorSubject)))) {
